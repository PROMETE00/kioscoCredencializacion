...
<aside class="d-panel d-person d-side">
    ...
    <div class="d-meta">
      <div class="d-meta__row">
        ...
        <span class="d-meta__value" id="capNombre"><?= esc($current['nombre'] ?? '—') ?></span>
      </div>

      <div class="d-meta__row">
        <span class="d-meta__label">No. control</span>
        <span class="d-meta__value" id="capControl"><?= esc($current['no_control'] ?? '—') ?></span>
      </div>

      <div class="d-meta__row">
        <span class="d-meta__label">Carrera</span>
        <span class="d-meta__value" id="capCarrera"><?= esc($current['carrera'] ?? '—') ?></span>
      </div>

      <div class="d-meta__row">
        <span class="d-meta__label">Semestre</span>
        <span class="d-meta__value" id="capSemestre"><?= esc($current['semestre'] ?? '—') ?></span>
      </div>

      <div class="d-meta__row">
        <span class="d-meta__label">Estatus</span>
        <span class="d-meta__value" id="capEstatus"><?= esc($current['estatus'] ?? '—') ?></span>
      </div>
    </div>
